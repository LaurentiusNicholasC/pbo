...
class LibraryManagementSystem:
    def __init__(self, root):
        ...
        lbltitle = Label(self.root, text="Library Management System", bg='#1a1a1a', fg='#57a1f8', font=('Microsoft YaHei UI Light', 30, 'bold'), padx=2, pady=38)
        lbltitle.pack(side=TOP, fill=X)

        #=====================================================Data Frame Left======================================================
        frame = Frame(self.root, bd=12, bg="#1a1a1a")
        frame.place(x=0, y=120, width=1550, height=400)
        DataFrameLeft = LabelFrame(frame, text="Membership Information", bg="#1a1a1a", fg="#57a1f8", relief=FLAT, font=("Microsoft YaHei UI Light", 15, "bold"), padx=2, pady=6)
        DataFrameLeft.place(x=0, y=5, width=808, height=370)
        
        #form MEMBER TYPE
        lblMember = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Member Type", font=('Microsoft YaHei UI Light', 12, 'bold'),padx=2, pady=6)
        ...
        #form PRN 
        lblPRN_No = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="PRN No", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblPRN_No.grid(row=1, column=0, sticky=W)
        txtPRN_NO = Entry(DataFrameLeft, bg="#1a1a1a",fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.prn_var, border=0)
        txtPRN_NO.grid(row=1, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=105)

        #form ID 
        lblID_No = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="ID No", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblID_No.grid(row=2, column=0, sticky=W)
        txtID_NO = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff",  font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.id_var, border=0)
        txtID_NO.grid(row=2, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=143)

        #form FIRST NAME
        lblFirstName = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="First Name", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblFirstName.grid(row=3, column=0, sticky=W)
        txtFirstName = Entry(DataFrameLeft,bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.firstname_var, border=0)
        txtFirstName.grid(row=3, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=181)

        #form  LAST NAME
        lblLastName = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Last Name", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblLastName.grid(row=4, column=0, sticky=W)
        txtLastName = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.lastname_var, border=0)
        txtLastName.grid(row=4, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=219)

        # form ADDRESS 1
        lblAddress1 = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Address 1", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblAddress1.grid(row=5, column=0, sticky=W)
        txtAddress1 = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.address1_var, border=0)
        txtAddress1.grid(row=5, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=257)

        #form ADDRESS 2
        lblAddress2 = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Address 2", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblAddress2.grid(row=6, column=0, sticky=W)
        txtAddress2 = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.address2_var, border=0)
        txtAddress2.grid(row=6, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=295)

        #form POST CODE
        lblPostCode = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Post Code", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblPostCode.grid(row=7, column=0, sticky=W)
        txtPostCode = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.postcode_var, border=0)
        txtPostCode.grid(row=7, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=333)

        #form ID 
        lblMobile = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Mobile Phone", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblMobile.grid(row=8, column=0, sticky=W)
        txtMobile = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.mobile_var, border=0)
        txtMobile.grid(row=8, column=1)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=128, y=371)

        #form BOOK ID 
        lblBookId = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Book ID", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblBookId.grid(row=0, column=2, sticky=W)
        txtBookid = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.bookid_var, border=0)
        txtBookid.grid(row=0, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=67)

        #form BOOK ID 
        lblBookTitle = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Book Title", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblBookTitle.grid(row=1, column=2, sticky=W)
        txtBookTitle = Entry(DataFrameLeft,  bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.booktitle_var, border=0)
        txtBookTitle.grid(row=1, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=105)
       
        #form AUTHOR 
        lblauthorName = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Author", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblauthorName.grid(row=2, column=2, sticky=W)
        txtauthorName = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.author_var, border=0)
        txtauthorName.grid(row=2, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=143)

        #form Date Borrowed
        lblDateBorrowed = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Date Borrowed", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblDateBorrowed.grid(row=3, column=2, sticky=W)
        txtDateBorrowed = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.dateborrowed_var, border=0)
        txtDateBorrowed.grid(row=3, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=181)

        #form Date Due
        lblDateDue = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Due Date", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblDateDue.grid(row=4, column=2, sticky=W)
        txtDateDue = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.datedue_var, border=0)
        txtDateDue.grid(row=4, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=219)

        #form Days on Book   
        lblDaysOnBook = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Days on Book", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblDaysOnBook.grid(row=5, column=2, sticky=W)
        txtDaysOnBook = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.daysonbook, border=0)
        txtDaysOnBook.grid(row=5, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=257)

        #form Late Return      
        lblLateReturnFine = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Late Return Fine", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblLateReturnFine.grid(row=6, column=2, sticky=W)
        txtLateReturnFine = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.lateratefine_var, border=0)
        txtLateReturnFine.grid(row=6, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=295)

        #form Overdue     
        lblDateOverDue = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Date Over Due", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblDateOverDue.grid(row=7, column=2, sticky=W)
        txtDateOverDue = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.dateoverdue, border=0)
        txtDateOverDue.grid(row=7, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=333)

        #form Date Due      
        lblActualPrice = Label(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", text="Actual Price", font=("Microsoft YaHei UI Light", 12, "bold"), padx=2, pady=6)
        lblActualPrice.grid(row=8, column=2, sticky=W)
        txtActualPrice = Entry(DataFrameLeft, bg="#1a1a1a", fg="#ffffff", font=("Microsoft YaHei UI Light", 12), width=29, textvariable=self.finallprice, border=0)
        txtActualPrice.grid(row=8, column=3)
        Frame(frame, width=255, height=2, bg="#ffffff").place(x=538, y=371)
        
        # Frame(frame, width=1, height=345, bg="black").place(x=860, y=29)

        #=====================================================Data Frame Right======================================================
        DataFrameRight = LabelFrame(frame, text="Book Detail", bg="#1a1a1a", fg="#57a1f8", relief=FLAT, font=("Microsoft YaHei UI Light", 15, "bold"), padx=2, pady=6)
        DataFrameRight.place(x=1050, y=5, width=540, height=400)

        self.txtbox=Text(DataFrameRight, bg="#262626",fg="#ffffff", font=("times new roman", 12, "bold"), width=32, height=16, padx=2, pady=6)
        ...
        #=====================================================Button Frame======================================================
        FrameButton = Frame(self.root, bd=12, relief=FLAT, bg="#1a1a1a")
        ...
        #=====================================================Information Frame======================================================
        FrameDetails = Frame (self.root, relief=FLAT, padx=0, pady=20, bg="#1a1a1a")
        FrameDetails.place(x=0, y=520, width=1550, height=400)
        
        Table_frame=Frame(FrameDetails, bd=6, relief=RIDGE, bg="#1a1a1a")
